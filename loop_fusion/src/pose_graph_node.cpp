...
int main(int argc, char **argv)
{
    ...
    string vocabulary_file = "/home/greymatters/project/altivision/src/XVoyager/support_files/brief_k10L6.bin";
    cout << "vocabulary_file" << vocabulary_file << endl;
    posegraph.loadVocabulary(vocabulary_file);

    BRIEF_PATTERN_FILE = "/home/greymatters/project/altivision/src/XVoyager/support_files/brief_pattern.yml";
