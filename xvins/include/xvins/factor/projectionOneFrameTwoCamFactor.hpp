#ifndef XVINS_PROJECTION_ONE_FRAME_TWO_CAM_FACTOR_HPP_
#define XVINS_PROJECTION_ONE_FRAME_TWO_CAM_FACTOR_HPP_
...
#endif // XVINS_PROJECTION_ONE_FRAME_TWO_CAM_FACTOR_HPP_
