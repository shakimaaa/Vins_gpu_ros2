#ifndef XVINS_FEATURE_MANAGER_HPP_
#define XVINS_FEATURE_MANAGER_HPP_
...
class FeaturePerId
{
  public:
    ...
    int solve_flag; // 0: not solved; 1: solved successfully; 2: solve failed
...
#endif // XVINS_FEATURE_MANAGER_HPP_
